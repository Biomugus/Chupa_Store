    ...
    <section className={styles.features}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          При покупке приклада , рукоятки или любого другого аксессуара нам важно, что бы Вы
          понимали и могли по достоинству оценить, как мы работаем - какие материалы используем, чем
          отличаемся от других и в чём наша уникальность. Для этого ознакомьтесь с разделом ниже
        </p>
      </div>
